...
public class BookServiceTest {
    ...
    void getAllTest() {
        bookService.insert(new Book("Книга 1", new Author(1L,"Автор 13"), new Genre(1L,"Роман")));
        bookService.insert(new Book("Книга 2", new Author(1L,"Автор 14"), new Genre(1L,"Роман")));
        bookService.insert(new Book("Книга 3", new Author(1L,"Автор 15"), new Genre(1L,"Роман")));
        bookService.insert(new Book("Книга 4", new Author(1L,"Автор 16"), new Genre(1L,"Роман")));
        bookService.insert(new Book("Книга 5", new Author(1L,"Автор 17"), new Genre(1L,"Роман")));
        bookService.insert(new Book("Книга 6", new Author(1L,"Автор 18"), new Genre(1L,"Роман")));
