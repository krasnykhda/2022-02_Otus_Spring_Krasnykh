...
public class BookDaoImplTest {
    ...
    void getAllTest() {
        ...
        bookDao.insert(new Book("Книга 2", new Author(1L, "Автор 14"), new Genre(1L, "Роман")));
        bookDao.insert(new Book("Книга 3", new Author(1L, "Автор 14"), new Genre(1L, "Роман")));
        bookDao.insert(new Book("Книга 4", new Author(1L, "Автор 14"), new Genre(1L, "Роман")));
        bookDao.insert(new Book("Книга 5", new Author(1L, "Автор 14"), new Genre(1L, "Роман")));
        bookDao.insert(new Book("Книга 6", new Author(1L, "Автор 14"), new Genre(1L, "Роман")));
    ...
    void getByIdTest() {
        ...
        var book1 = bookDao.insert(new Book("Книга 7", new Author(2L, "Автор 1"), new Genre(2L, "Роман")));
        var book2 = bookDao.insert(new Book("Книга 8", new Author(2L, "Автор 1"), new Genre(2L, "Роман")));
        var book3 = bookDao.insert(new Book("Книга 9", new Author(2L, "Автор 1"), new Genre(2L, "Роман")));
        var book4 = bookDao.insert(new Book("Книга 10", new Author(2L, "Автор 1"), new Genre(2L, "Роман")));
        var book5 = bookDao.insert(new Book("Книга 11", new Author(2L, "Автор 1"), new Genre(2L, "Роман")));
        var book6 = bookDao.insert(new Book("Книга 12", new Author(2L, "Автор 1"), new Genre(2L, "Роман")));
    ...
    void insertTest() {
        var book = bookDao.insert(new Book("Книга 13", new Author(1L, "Автор 1"), new Genre(1L, "Роман")));
    ...
    void deleteTest() {
        var book1 = bookDao.insert(new Book("Книга 13", new Author(1L, "Автор 1"), new Genre(1L, "Роман")));
        var book2 = bookDao.insert(new Book("Книга 14", new Author(1L, "Автор 1"), new Genre(1L, "Роман")));
        var book3 = bookDao.insert(new Book("Книга 15", new Author(1L, "Автор 1"), new Genre(1L, "Роман")));
        var book4 = bookDao.insert(new Book("Книга 16", new Author(1L, "Автор 1"), new Genre(1L, "Роман")));
        var book5 = bookDao.insert(new Book("Книга 17", new Author(1L, "Автор 1"), new Genre(1L, "Роман")));
        var book6 = bookDao.insert(new Book("Книга 18", new Author(1L, "Автор 1"), new Genre(1L, "Роман")));
